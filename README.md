...
- `ANDROID_KEYSTORE_BASE64` — فایل JKS به Base64
...
```
بعد همان فایل را امن نگه دار و مقدار Base64 آن را در Secret بالا قرار بده. **کلید خصوصی را داخل ریپوی عمومی Commit نکن.**
